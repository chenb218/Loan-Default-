...
loan_summary %>%
  ...
  geom_text(aes(label = round(pct,2)) , vjust = 2.5, colour = "white") + 
  labs(title="Loan Defaults ", x="Loan Status", y="PCT") 
#85% of the data are current - 15% are default
...
#Create Profile for each variable
...
#Predict a probabilty for a plot
...
#Predicted probability for plot 
